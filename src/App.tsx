...
function App() {
  ...
  useEffect(() => {
    if (selectedBrand) {
      ...
      const modelPath = `/annotation-tool/public/Dataset/${selectedBrand}/models.json`;
  ...
  const handleStartAnnotation = () => {
    if (selectedBrand && selectedModel) {
      ...
      fetch(`/annotation-tool/public/Dataset/${selectedBrand}/${selectedModel}/components.json`)
        .then(response => response.json())
        .then(data => {
          ...
          setCurrentImage(`/annotation-tool/public/Dataset/${selectedBrand}/${selectedModel}/interior.png`);
